...
public class HibernateConfig {
    ...
    private static void hibernateDevelopmentConfiguration(Properties props) throws IOException {
        props.put("hibernate.connection.url", ApplicationConfig.getProperty("db.connection.string") + ApplicationConfig.getProperty("jar"));
        props.put("hibernate.connection.username", ApplicationConfig.getProperty("jar"));
        props.put("hibernate.connection.password", ApplicationConfig.getProperty("jar"));
    }
